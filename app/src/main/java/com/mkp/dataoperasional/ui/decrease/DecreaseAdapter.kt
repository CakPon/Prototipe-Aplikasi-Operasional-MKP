...
import com.mkp.dataoperasional.ui.decrease.detail.DetailDecreaseActivity

class DecreaseAdapter(
    ...
    override fun getChildView(
        ...
        binding.root.setOnClickListener {
            val intent = Intent(context, DetailDecreaseActivity::class.java).apply {
                putExtra("CATEGORY", getGroup(groupPosition) as String)
                putExtra("COLOR", item.color)
                putStringArrayListExtra("SIZES", ArrayList(item.items.map { it.size }))
            }
